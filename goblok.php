...
function change(){
        ...
        echo "\n".color("yellow","!] Ambek voc GOJEKINFCR");
        echo "\n".color("yellow","!] Tunggu ! Sabar Nang.");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        ...
        sleep(3);
        $boba11 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"GOJEKINFCR"}');
        ...
        $expired4 = getStr1('"expiry_date":"','"',$cekvoucher,'4');
         setpin:
         echo "\n".color("nevy","?] Nak set pin?: y/n ");
         $pilih1 = trim(fgets(STDIN));
         if($pilih1 == "y" || $pilih1 == "Y"){
         //if($pilih1 == "y" && strpos($no, "628")){
         echo color("red","========( PIN ANDA = 123654 )========")."\n";
         $data2 = '{"pin":"787878"}';
